# Тема №20. Свойства узлов 🍍

Теперь давайте более внимательно взглянем на DOM-узлы.

В рамках данной темы мы подробнее разберём, что они собой представляют и изучим их основные свойства.

<div align="center">
  <img alt="Project Demo" src="./JS20.jpg" />
</div>
...
<div align="center">
  <img alt="Project Demo" src="./JS20_dom-class-hierarchy.svg" />
</div>
...
<script>
  let name = prompt("Введите ваше имя?", "<b>Человек-паук!</b>");
...
2. Во второй `<div>` имя приходит "как текст", поэтому мы видим `<b>Человек-паук!</b>`.
