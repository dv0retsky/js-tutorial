# Тема №18. Навигация по DOM-элементам 🍌

`DOM` позволяет нам делать что угодно с элементами и их содержимым, но для начала нужно получить соответствующий DOM-объект.

<div align="center">
  <img alt="Project Demo" src="./JS18.jpg" />
</div>
...
<div align="center">
  <img alt="Project Demo" src="./JS18_dom_links.svg" />
</div>
...
`<html>` = `document.documentElement`: Самый верхний узел документа: `document.documentElement`. В DOM он соответствует тегу `<html>`.
...
<div align="center">
  <img alt="Project Demo" src="./JS18_dom_links_elements.svg" />
</div>
